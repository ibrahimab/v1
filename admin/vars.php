...
if(preg_match("@^test\.@",$_SERVER["HTTP_HOST"]) or preg_match("@/html_test/@",$unixdir)) {
	...
	if($_COOKIE["acceptance_email"]) {
		// logged in user at Chalet.nl
		$vars["lokale_testserver_mailadres"]=$_COOKIE["acceptance_email"];
	} elseif($_SERVER["REMOTE_ADDR"]=="31.223.173.113" or $_SERVER["REMOTE_ADDR"]=="37.34.56.191") {
		// IP WebTastic
...
$vars["bestelmailfax_graagpermailoffaxbevestigen"]=array("D"=>"Wir bitten Sie uns umgehend eine Buchungsbest�tigung zu schicken per Mail. Vielen dank im voraus.","E"=>"Please confirm this reservation as soon as possible by email.","N"=>"We vragen u deze reservering zo snel mogelijk per e-mail aan ons te bevestigen.");
...
# Kenmerken Winter
#
$vars["kenmerken_type_1"]=array(1=>"catering mogelijk",2=>"aan de piste",3=>"sauna (priv�)",4=>"zwembad (priv�)",5=>"goed voor kids",6=>"grote groepen",7=>"prijsbewust",8=>"alleen het allerbeste (topselectie)",9=>"winter-wellness",10=>"open haard/houtkachel",11=>"huisdieren toegestaan",12=>"allergievrij",13=>"verhuur zondag t/m zondag",14=>"huisje voor 2",15=>"bijzonder",16=>"wasmachine",17=>"balkon",18=>"terras of balkon",19=>"huisdieren NIET toegestaan",20=>"internetverbinding",21=>"charmant chalet",22=>"internet via Wi-Fi",23=>"Jacuzzi/bubbelbad");
$vars["kenmerken_accommodatie_1"]=array(1=>"catering mogelijk",2=>"aan de piste",3=>"sauna (priv�)",4=>"zwembad (priv�)",5=>"goed voor kids",6=>"grote groepen",7=>"prijsbewust",8=>"alleen het allerbeste (topselectie)",9=>"winter-wellness",10=>"sauna",11=>"zwembad",12=>"open haard/houtkachel",13=>"huisdieren toegestaan",14=>"allergievrij",15=>"verhuur zondag t/m zondag",16=>"bijzonder",17=>"wasmachine",18=>"balkon",19=>"terras of balkon",20=>"huisdieren NIET toegestaan",21=>"internetverbinding",22=>"charmant chalet",23=>"internet via Wi-Fi",24=>"Jacuzzi/bubbelbad");
$vars["kenmerken_plaats_1"]=array(1=>"kindvriendelijk",2=>"prijsbewust",4=>"winter-wellness",5=>"meer dan alleen ski�n",6=>"een 10 voor apr�s-ski",7=>"altijd sneeuw",8=>"voor beginnende wintersporters",9=>"voor fanatieke wintersporters",10=>"snowboardfun",11=>"wandelen",12=>"langlaufen",13=>"charmant skidorp",14=>"super ski stations"); # 3 is nog leeg
$vars["kenmerken_skigebied_1"]=array(1=>"kindvriendelijk",2=>"prijsbewust",3=>"winter-wellness",4=>"meer dan alleen ski�n",5=>"altijd sneeuw",6=>"voor beginnende wintersporters",7=>"voor fanatieke wintersporters",8=>"snowboardfun",9=>"wandelen",10=>"langlaufen");
