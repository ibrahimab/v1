...
$vars["blogcategorie_italissima"]=array(1=>"culinair",2=>"tradities & feestdagen",3=>"bezienswaardigheden",4=>"mode & design",5=>"films",6=>"overig");
...
# Kenmerken Winter
#
$vars["kenmerken_type_1"]=array(1=>"catering mogelijk",2=>"aan de piste",3=>"sauna (privé)",4=>"zwembad (privé)",5=>"goed voor kids",6=>"voor groepen",7=>"prijsbewust",8=>"alleen het allerbeste (topselectie)",9=>"vleugje wellness",10=>"open haard/houtkachel",11=>"huisdieren toegestaan",12=>"allergievrij",13=>"verhuur zondag t/m zondag",14=>"huisje voor 2",15=>"bijzonder",16=>"wasmachine",17=>"balkon",18=>"terras of balkon",19=>"huisdieren NIET toegestaan",20=>"internetverbinding");
$vars["kenmerken_accommodatie_1"]=array(1=>"catering mogelijk",2=>"aan de piste",3=>"sauna (privé)",4=>"zwembad (privé)",5=>"goed voor kids",6=>"voor groepen",7=>"prijsbewust",8=>"alleen het allerbeste (topselectie)",9=>"vleugje wellness",10=>"sauna",11=>"zwembad",12=>"open haard/houtkachel",13=>"huisdieren toegestaan",14=>"allergievrij",15=>"verhuur zondag t/m zondag",16=>"bijzonder",17=>"wasmachine",18=>"balkon",19=>"terras of balkon",20=>"huisdieren NIET toegestaan",21=>"internetverbinding");
$vars["kenmerken_plaats_1"]=array(1=>"kindvriendelijk",2=>"prijsbewust",4=>"vleugje wellness",5=>"meer dan alleen skiën",6=>"een 10 voor après-ski",7=>"altijd sneeuw",8=>"voor beginnende wintersporters",9=>"voor fanatieke wintersporters",10=>"snowboardfun",11=>"wandelen",12=>"langlaufen",13=>"charmant skidorp",14=>"super ski stations"); # 3 is nog leeg
$vars["kenmerken_skigebied_1"]=array(1=>"kindvriendelijk",2=>"prijsbewust",3=>"vleugje wellness",4=>"meer dan alleen skiën",5=>"altijd sneeuw",6=>"voor beginnende wintersporters",7=>"voor fanatieke wintersporters",8=>"snowboardfun",9=>"wandelen",10=>"langlaufen");

#
# Kenmerken Zomer
#
$vars["kenmerken_type_2"]=array(1=>"huisje voor 2",2=>"los, vrijstaand huis",3=>"sauna (privé)",4=>"zwembad (privé)",5=>"goed voor kids",6=>"voor groepen",7=>"prijsbewust",8=>"alleen het allerbeste (topselectie)",9=>"vleugje wellness",10=>"open haard/houtkachel",11=>"huisdieren toegestaan",12=>"allergievrij",13=>"verhuur zondag t/m zondag",14=>"niet vrijstaand/geschakeld/appartement",15=>"vrijstaand huis (met meerdere huizen)",16=>"bijzonder",17=>"terras (privé)",18=>"wasmachine",19=>"balkon",20=>"terras of balkon",21=>"huisdieren NIET toegestaan",22=>"internetverbinding",23=>"omheinde tuin");
$vars["kenmerken_accommodatie_2"]=array(1=>"actief in de bergen",2=>"golfbaan",3=>"sauna (privé)",4=>"zwembad (privé)",5=>"goed voor kids",6=>"voor groepen",7=>"prijsbewust",8=>"alleen het allerbeste (topselectie)",9=>"vleugje wellness",10=>"sauna",11=>"zwembad",12=>"open haard/houtkachel",13=>"huisdieren toegestaan",14=>"allergievrij",15=>"verhuur zondag t/m zondag",16=>"stekje aan het water",17=>"levensgenieters",18=>"huisje voor 2",19=>"tennisbaan (bij accommodatie)",20=>"wijnstreek",21=>"citytrip",22=>"los, vrijstaand huis",23=>"niet vrijstaand/geschakeld/appartement",24=>"vakantiepark",25=>"te gast op de boerderij",26=>"speeltoestellen",27=>"vrijstaand huis (met meerdere huizen)",28=>"bijzonder",29=>"tennisbaan (in directe omgeving)",30=>"terras (privé)",31=>"paardrijden (in directe omgeving)",32=>"wasmachine",33=>"balkon",34=>"terras of balkon",35=>"huisdieren NIET toegestaan",36=>"internetverbinding",37=>"wijndomein",38=>"omheinde tuin",39=>"centrum op loopafstand (max. 1km)",40=>"restaurant op domein",41=>"agriturismo");
