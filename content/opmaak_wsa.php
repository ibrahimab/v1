...
#			include "content/".$id.".html";
	...
	<div id="footer">Wintersportaccommodaties.nl - Lindenhof 5 - 3442 GT Woerden - <b><nobr>Telefoon 0348 - 43 46 49</nobr></b></div>
	 <div id="footer" class=\"noprint\" style="text-align:center;"> <a href="<?php echo htmlentities($vars["websiteinfo"]["privacystatement"][$vars["website"]])?>">Privacy statement</a> - <a href="<?php echo htmlentities($vars["websiteinfo"]["disclaimer"][$vars["website"]])?>">Disclaimer</a></div>
	</div>
	<div id="printlogo">
