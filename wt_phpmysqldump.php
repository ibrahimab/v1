...
if(!isset($_SERVER["PHP_AUTH_USER"])) {
	...
	exit;
} elseif($_SERVER["PHP_AUTH_USER"]=="wtmysql" and $_SERVER["PHP_AUTH_PW"]=="k333232fdj2383289shaskjl3kl33i0934jjh84" and ($_SERVER["REMOTE_ADDR"]=="31.223.173.113" or $_SERVER["REMOTE_ADDR"]=="87.250.137.107" or $_SERVER["REMOTE_ADDR"]=="87.250.153.108" or $_SERVER["REMOTE_ADDR"]=="37.34.56.191")) {
	# okay!
} else {
