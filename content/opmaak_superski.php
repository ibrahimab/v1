...
echo "<br><b>Onze skigebieden</b><br><br>";
echo "<li><a href=\"".$vars["path"]."\"".($rel_nofollow ? " rel=\"nofollow\"" : "").">Skigebied 1</a></li>";
echo "</div>";
echo "<div class=\"divContentIND\">";
echo "<BR><BR><br>";
echo "<li><a href=\"".$vars["path"]."\"".($rel_nofollow ? " rel=\"nofollow\"" : "").">Skigebied 2</a></li>";
echo "</div>";
echo "<div class=\"divContentIND\">";
echo "<BR><BR><br>";
echo "<li><a href=\"".$vars["path"]."\"".($rel_nofollow ? " rel=\"nofollow\"" : "").">Skigebied 3</a></li>";
echo "</div>";
echo "</div>";
echo "</div>";
