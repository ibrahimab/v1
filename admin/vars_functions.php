...
/**
 * Function is used to set the payment texts on the invoice and calculate the amounts for the invoice
 * It is also used on the docdata payment pages
 *
 * @param array $gegevens
 * @return array
 */
function factuur_totaals($gegevens) {

	global $aanbetalen, $restbetalen, $reedsvoldaan, $aanbetaling2_factuurtekst;
