...
//if($id=="index") {
	echo "<div id=\"ondercolofon\" class=\"noprint\"><a href=\"".$vars["path"]."agriturismo-italie\">agriturismi in Itali&euml;</a>&nbsp;&nbsp;-&nbsp;&nbsp;<a href=\"http://www.chalet.nl/land/Italie/\" target=\"_blank\">wintersport in Itali&euml;</a> | <a href=\"".$vars["path"]."disclaimer.php\">Disclaimer</a> - <a href=\"".$vars["path"]."privacy-statement.php\">Privacy statement</a></div>";
//}
