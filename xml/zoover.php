...
if($_GET["campaign"]=="zooverbe") {
	...
	if($_GET["specialfeed"]) {
		$campaigncode="?utm_source=zoover&utm_medium=partnersite&utm_campaign=zoover_0%2C55";
	} else {
		$campaigncode="?utm_source=zoover&utm_medium=partnersite&utm_campaign=zoover_0%2C35";
	}
}
