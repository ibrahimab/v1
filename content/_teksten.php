...
# tijdelijk tekst inclusief verzendmethode-melding:
#$txt["nl"]["vars"]["mailopties_wzt1_2"]="Met je wachtwoord ([WACHTWOORD]) kun je via [LINK] tot 28 dagen voor vertrek in je reservering aanpassingen doen (bij last minute boekingen is dit langer mogelijk). Heb je liever dat wij bepaalde zaken voor je aanpassen dan horen wij het graag zodat wij het voor je in orde kunnen maken.\n\nBij wijzigingen in de boeking zul je een nieuwe bevestiging (= tevens factuur) ontvangen, het makkelijkst is dus als je zoveel mogelijk in één keer wijzigt.\n\nVerder wijzen wij je voor een eventueel nog openstaand bedrag op de uiterste betaaldatum 6 weken voor vertrek (of indien reeds verstreken per omgaande).\n\nOngeveer 10 dagen voor vertrek ontvang je de reisdocumenten met daarin extra informatie over jullie route, verblijf, sleuteladres, vouchers voor eventueel bijgeboekte opties enz. Graag vernemen wij hoe je deze reisdocumenten wilt ontvangen (per post of per e-mail). Bezoek daarvoor de volgende link:\n[VERZENDMETHODE_REISDOCUMENTEN_URL]\n\nMet vriendelijke groet,\nMedewerkers [WEBSITE]\n\nTel: [TELEFOONNUMMER]";
#$txt["en"]["vars"]["mailopties_wzt1_2"]="With your password ([WACHTWOORD]) you can make changes with your reservation up to 28 days before your departure via [LINK]. If you rather have us make the changes, please contact us with your wishes and we will make the changes instead.\n\nWhen you make a change with your reservation, you will receive a new confirmation (which is also your invoice), so it is the easiest to make as many changes at the same time as possible.\n\nFurthermore I would like to direct your attention to the payment, if you have not fully paid yet. The deadline for this payment is six weeks before your departure. Or, if you are past this deadline, we would like to receive the payment as soon as possible.\n\nAround 10 days before your departure you will receive your travel documents via mail, which includes extra information about the directions, your stay, where to pick up your key, vouchers for additional options, et cetera.\n\nBest regards,\nEmployees [WEBSITE]\n\nTel: [TELEFOONNUMMER]";
