<?php
/**
 * File for NewyseServiceWsdlClass to communicate with SOAP service
 * @package NewyseService
 */
/**
 * NewyseServiceWsdlClass to communicate with SOAP service
 * Documentation : Newyse webservice 2.0
 * @package NewyseService
 */
class NewyseServiceWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
    /**
     ...
     * @var string
     */
    const VALUE_WSDL_URL = 'http://scws.newyse.com/nwsservice_europe_live/nwsws/newyseservice?wsdl';
    /**
    ...
    /**
     * Constructor
     * @uses NewyseServiceWsdlClass::setLastError()
     * @uses NewyseServiceWsdlClass::initSoapClient()
     * @uses NewyseServiceWsdlClass::initInternArrayToIterate()
     * @uses NewyseServiceWsdlClass::_set()
     ...
     * @return NewyseServiceWsdlClass|null
     */
    public static function __set_state(array $_array,$_className = __CLASS__)
    {
        if(class_exists($_className))
        {
            ...
            if(is_object($object) && is_subclass_of($object,'NewyseServiceWsdlClass'))
            {
     ...
     * @uses NewyseServiceClassMap::classMap()
     * @uses NewyseServiceWsdlClass::getDefaultWsdlOptions()
     * @uses NewyseServiceWsdlClass::getSoapClientClassName()
     * @uses NewyseServiceWsdlClass::setSoapClient()
     * @param array $_wsdlOptions WSDL options
     * @return void
     */
    public function initSoapClient($_wsdlOptions)
    {
        if(class_exists('NewyseServiceClassMap',true))
        {
            $wsdlOptions = array();
            $wsdlOptions['classmap'] = NewyseServiceClassMap::classMap();
     ...
     * If a class is named as {NewyseService}SoapClient, then this is the class that will be used.
    ...
    {
        if(class_exists('NewyseServiceSoapClient',false) && is_subclass_of('NewyseServiceSoapClient','SoapClient',false))
            return 'NewyseServiceSoapClient';
        else
            return 'SoapClient';
    }
    /**
     * Method returning all default options values
     * @uses NewyseServiceWsdlClass::WSDL_CACHE_WSDL
     * @uses NewyseServiceWsdlClass::WSDL_COMPRESSION
     * @uses NewyseServiceWsdlClass::WSDL_CONNECTION_TIMEOUT
     * @uses NewyseServiceWsdlClass::WSDL_ENCODING
     * @uses NewyseServiceWsdlClass::WSDL_EXCEPTIONS
     * @uses NewyseServiceWsdlClass::WSDL_FEATURES
     * @uses NewyseServiceWsdlClass::WSDL_LOGIN
     * @uses NewyseServiceWsdlClass::WSDL_PASSWORD
     * @uses NewyseServiceWsdlClass::WSDL_SOAP_VERSION
     * @uses NewyseServiceWsdlClass::WSDL_STREAM_CONTEXT
     * @uses NewyseServiceWsdlClass::WSDL_TRACE
     * @uses NewyseServiceWsdlClass::WSDL_TYPEMAP
     * @uses NewyseServiceWsdlClass::WSDL_URL
     * @uses NewyseServiceWsdlClass::VALUE_WSDL_URL
     * @uses NewyseServiceWsdlClass::WSDL_USER_AGENT
     * @uses NewyseServiceWsdlClass::WSDL_PROXY_HOST
     * @uses NewyseServiceWsdlClass::WSDL_PROXY_PORT
     * @uses NewyseServiceWsdlClass::WSDL_PROXY_LOGIN
     * @uses NewyseServiceWsdlClass::WSDL_PROXY_PASSWORD
     * @uses NewyseServiceWsdlClass::WSDL_LOCAL_CERT
     * @uses NewyseServiceWsdlClass::WSDL_PASSPHRASE
     * @uses NewyseServiceWsdlClass::WSDL_AUTHENTICATION
     * @uses NewyseServiceWsdlClass::WSDL_SSL_METHOD
     ...
     * @uses NewyseServiceWsdlClass::getSoapClient()
     * @uses NewyseServiceWsdlClass::getFormatedXml()
     ...
     * @uses NewyseServiceWsdlClass::getSoapClient()
     * @uses NewyseServiceWsdlClass::convertStringHeadersToArray()
     ...
     * @uses NewyseServiceWsdlClass::count()
     * @return int
     */
     ...
     * @uses NewyseServiceWsdlClass::getInternArrayToIterate()
     * @uses NewyseServiceWsdlClass::getInternArrayToIterateIsArray()
     * @return int
     */
     ...
     * @uses NewyseServiceWsdlClass::offsetGet()
     * @return mixed
     */
     ...
     * @uses NewyseServiceWsdlClass::getInternArrayToIterateOffset()
     * @uses NewyseServiceWsdlClass::setInternArrayToIterateOffset()
     * @return int
     */
     ...
     * @uses NewyseServiceWsdlClass::getInternArrayToIterateOffset()
     * @uses NewyseServiceWsdlClass::offsetExists()
     * @return bool true|false
     */
     ...
     * @see NewyseServiceWsdlClass::offsetGet()
     * @uses NewyseServiceWsdlClass::offsetGet()
     * @param int $_index
     * @return mixed
     */
     ...
     * @uses NewyseServiceWsdlClass::getAttributeName()
     * @uses NewyseServiceWsdlClass::__toString()
     * @uses NewyseServiceWsdlClass::_set()
     * @uses NewyseServiceWsdlClass::_get()
     * @uses NewyseServiceWsdlClass::setInternArrayToIterate()
     * @uses NewyseServiceWsdlClass::setInternArrayToIterateIsArray()
     * @uses NewyseServiceWsdlClass::setInternArrayToIterateOffset()
     ...
     * @uses NewyseServiceWsdlClass::item()
     * @return mixed
     */
     ...
     * @uses NewyseServiceWsdlClass::item()
     * @uses NewyseServiceWsdlClass::length()
     * @return mixed
     */
