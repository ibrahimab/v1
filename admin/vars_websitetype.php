...
#	$vars["mailingmanagerid"]="cmkdlo9d";
	...
	$vars["reisverzekering_mogelijk"]=1;
	$vars["wederverkoop"]=true;
} elseif($_SERVER["HTTP_HOST"]=="www.italissima.be" or ($vars["lokale_testserver"] and $vars["testsite"]=="italissimabe")) {
	# Italissima.be
	$vars["websitetype"]=7;
	$vars["websitenaam"]="Italissima";
	$vars["langewebsitenaam"]="Italissima";
...
$vars["websites"]=array("C"=>"Chalet.nl Winter","Z"=>"Zomerhuisje.nl","W"=>"SuperSki","E"=>"Chalet.eu Engelstalig Winter","S"=>"Chalet.eu Engelstalig Zomer (niet meer actief)","T"=>"Chalettour.nl Winter","O"=>"Chalettour.nl Zomer (niet meer actief)","B"=>"Chalet.be Winter","D"=>"Chalet Duitstalig Winter","N"=>"Zomerhuisje.eu","V"=>"Chalets in Vallandry (.nl)","Q"=>"Chalets in Vallandry (.com)","I"=>"Italissima.nl","K"=>"Italissima.be");
...
$vars["websites_wzt"][2]=array("Z"=>"Zomerhuisje.nl","N"=>"Zomerhuisje.eu (gericht op België)","S"=>"Chalet.eu Engelstalig Zomer (niet meer actief)","O"=>"Chalettour.nl Zomer (niet meer actief)","V"=>"Chalets in Vallandry (.nl)","Q"=>"Chalets in Vallandry (.com)","I"=>"Italissima.nl","K"=>"Italissima.be");
...
$vars["websites_wzt_actief"][2]=array("Z"=>"Zomerhuisje.nl","N"=>"Zomerhuisje.eu (gericht op België)","V"=>"Chalets in Vallandry (.nl)","Q"=>"Chalets in Vallandry (.com)","I"=>"Italissima.nl","K"=>"Italissima.be");
...
$vars["websitetype_namen"]=array(1=>"Chalet.nl/.eu/.be",2=>"SuperSki",3=>"Zomerhuisje.nl/.eu",4=>"Chalettour.nl",6=>"Chalets in Vallandry (.nl en .com)",7=>"Italissima (.nl en .be)");
