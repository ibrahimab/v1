...
#
#
# functions t.b.v. XML-import (o.a. van specifieke leveranciers_
#
#
...
function marche_RPC_get_house_calendar($RPC_login, $RPC_pass, $idhouse, $da_data, $numweeks)
{ $l=marche_get_info("get_house_calendar", Array("RPC_login","RPC_pass","idhouse","da_data","numweeks"), Array($RPC_login, $RPC_pass, $idhouse, $da_data, $numweeks));
  return $l;
};
