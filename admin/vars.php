...
# Kenmerken Winter
#
$vars["kenmerken_type_1"]=array(1=>"catering mogelijk",2=>"aan de piste",3=>"sauna (privé)",4=>"zwembad (privé)",5=>"goed voor kids",6=>"grote groepen",7=>"prijsbewust",8=>"alleen het allerbeste (topselectie)",9=>"vleugje wellness",10=>"open haard/houtkachel",11=>"huisdieren toegestaan",12=>"allergievrij",13=>"verhuur zondag t/m zondag",14=>"huisje voor 2",15=>"bijzonder",16=>"wasmachine",17=>"balkon",18=>"terras of balkon",19=>"huisdieren NIET toegestaan",20=>"internetverbinding",21=>"charmant chalet");
$vars["kenmerken_accommodatie_1"]=array(1=>"catering mogelijk",2=>"aan de piste",3=>"sauna (privé)",4=>"zwembad (privé)",5=>"goed voor kids",6=>"grote groepen",7=>"prijsbewust",8=>"alleen het allerbeste (topselectie)",9=>"vleugje wellness",10=>"sauna",11=>"zwembad",12=>"open haard/houtkachel",13=>"huisdieren toegestaan",14=>"allergievrij",15=>"verhuur zondag t/m zondag",16=>"bijzonder",17=>"wasmachine",18=>"balkon",19=>"terras of balkon",20=>"huisdieren NIET toegestaan",21=>"internetverbinding",22=>"charmant chalet");
