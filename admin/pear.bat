...
FOR %%x IN ("O:\EasyPHP-5.3.9\www\chalet\admin/PEAR") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=O:\EasyPHP-5.3.9\www\chalet\admin/PEAR"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=O:\EasyPHP-5.3.9\www\chalet\admin"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=O:\EasyPHP-5.3.9\www\chalet\admin\"
