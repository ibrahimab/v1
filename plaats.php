...
if($plaatsid) {
	...
	if($db->next_record()) {
		...
		if($db->f("land_id")==5 and $db->f("skigebied_id")<>135 and $db->f("skigebied_id")<>142 and $db->f("skigebied_id")<>168 and $db->f("skigebied_id")<>219 and ($vars["website"]=="Z" or $vars["website"]=="N")) {
