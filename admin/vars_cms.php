...
#	$layout->menu_item("cms_blokkenhoofdpagina","Blokken hoofdpagina","",true);
	...
	$layout->submenu_item("cms_hoogtepunten","","cms_homepageblokken","Blokken winter",array("wzt"=>"1"),true);
	$layout->submenu_item("cms_hoogtepunten","","cms_homepageblokken","Blokken zomer",array("wzt"=>"2"),true);
...
#	$cms->settings[43]["log"]["active"]=true;
	...
	$cms->settings[59]["file"]="cms_homepageblokken.php";
...
$vars["xml_type"]=array(
	...
	27=>"Agence des Cimes - Arkiane (27)"
);
asort($vars["xml_type"]);
...
#		$return["plaats"]=$gegevens["stap1"]["accinfo"]["plaats"];
		...
		if($gegevens["stap1"]["mailtekst_klanten_vorig_seizoen"]) {
			...
			$return["body"]=ereg_replace("\[WEBSITE\]",$gegevens["stap1"]["website_specifiek"]["websitenaam"],$return["body"]);
			$return["body"]=ereg_replace("\[LINK_ALGEMEEN\]",($_SERVER["DOCUMENT_ROOT"]=="/home/webtastic/html" ? "http://dev.webtastic.nl/chalet/" : $vars["websites_basehref"][$gegevens["stap1"]["website"]])."rebook.php?goto=zoekenboek&bid=".$boekingid."&c=".substr(sha1($boekingid."_WT_488439fk3"),0,8)."&utm_source=email&utm_medium=email&utm_campaign=mail-volgend-seizoen-klant",$return["body"]);
