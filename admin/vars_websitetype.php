...
/**
 * Website-controller:
 * - determine which website is active
 * - configuration of each website
 *
 * For a list of these sites see:
 * https://github.com/Chalet/Website-Chalet.nl/wiki/Verschillende-websites-en-bijbehorende-variabelen
 *
...
//
// alowed hostnames per site (only C (Chalet.nl) for now)
// @todo: add other sites (E, D, T, B, Z, V, Q, I, K, H, X, Y)
//
$allowed_hostnames = [
	'C' => [
		'www.chalet.nl',
...
if($cron or in_array($_SERVER["HTTP_HOST"], $allowed_hostnames['C']) or ($vars["lokale_testserver"] and $vars["testsite"]=="C")) {
	//
	// Chalet.nl
	//
	$vars["websitetype"]=1;
	...
	$vars["livechat_code"]="4-VeMFxufQbX";
...
$vars["websiteinfo"]["livechat_code"]["E"]="4-VeMFxufQbX";
...
$vars["websiteinfo"]["wederverkoop"]["D"]=false;
...
$vars["websites_wzt"][1]=array("C"=>"Chalet.nl","E"=>"Chalet.eu (Engelstalig)","T"=>"Chalettour.nl (wederverkoop)","B"=>"Chalet.be","D"=>"Chaletonline.de Duitstalig","W"=>"SuperSki (niet meer actief)","V"=>"Chalets in Vallandry (.nl)","Q"=>"Chalets in Vallandry (.com)","X"=>"Venturasol Wintersport","Y"=>"Venturasol Vacances");
