...
if (!function_exists("datum")) {
	function datum($a,$time=0,$language='nl') {
		...
		if($language=="nl") {
			...
			$a = ereg_replace("(^|[^a-zA-Z0-9‰])DD MND","DD. MND",$a);
			$a = ereg_replace("(^|[^a-zA-Z0-9‰])D MND","D. MND",$a);
			$a = ereg_replace("(^|[^a-zA-Z0-9‰])DD MAAND","DD. MAAND",$a);
			$a = ereg_replace("(^|[^a-zA-Z0-9‰])D MAAND","D. MAAND",$a);
