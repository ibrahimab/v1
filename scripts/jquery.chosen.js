...
(function() {
  ...
  Chosen = (function(_super) {
    ...
    Chosen.prototype.winnow_results = function() {
      ...
      // toegevoegd
      search_without_special_chars=wt_removeDiacritics(this.search_field.val());

      // gewijzigd
      searchText = search_without_special_chars === this.default_text ? "" : $('<div/>').text($.trim(search_without_special_chars)).html();

      var searchText_org = this.search_field.val() === this.default_text ? "" : $('<div/>').text($.trim(this.search_field.val())).html();
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        if (!option.disabled && !option.empty) {
          if (option.group) {
            ...
            // toegevoegd
            without_special_chars=wt_removeDiacritics(option.html);

            // gewijzigd: hieronder option.html vervangen door without_special_chars
