...
#		echo "<div id=\"contactgegevens\">".wt_he($vars["websitenaam"])."&nbsp;&nbsp;&nbsp;".html("telefoonnummer")."&nbsp;&nbsp;&nbsp;<a href=\"mailto:".wt_he($vars["email"])."\">".wt_he($vars["email"])."</a></div>";
	...
	if($vars["verberg_directnaar"] and $vars["in_plaats_van_directnaar"]) {
		...
		echo "<a href=\"".$vars["path"].txt("menu_land")."/".wt_convert2url_seo(txt("frankrijk","index"))."/\"><span class=\"flag france\"></span>".html("frankrijk","index")."</a>";
		echo "<a href=\"".$vars["path"].txt("menu_land")."/".wt_convert2url_seo(txt("oostenrijk","index"))."/\"><span class=\"flag austria\"></span>".html("oostenrijk","index")."</a>";
		echo "<a href=\"".$vars["path"].txt("menu_land")."/".wt_convert2url_seo(txt("zwitserland","index"))."/\"><span class=\"flag switzerland\"></span>".html("zwitserland","index")."</a>";
		echo "<a href=\"".$vars["path"].txt("menu_land")."/".wt_convert2url_seo(txt("italie","index"))."/\"><span class=\"flag italy\"></span>".html("italie","index")."</a>";
...
#		echo "<span class=\"redtext\">&bull;</span>&nbsp;<a href=\"".txt("menu_land")."/".wt_convert2url_seo(txt("frankrijk","index"))."/\">".html("overigelanden","index")."</a><br />";
		...
		# Nieuwsbrief
		if($vars["nieuwsbrief_aanbieden"] and $NU_EVEN_NIET) {
...
if($vars["website"]=="C" or $vars["website"]=="B" or $vars["website"]=="T") {
	if($id!="index") {
		...
		echo "<ul>";
		echo "<li><a href=\"".$vars["path"]."land/Frankrijk/\" rel=\"nofollow\">Wintersport in Frankrijk</a></li>";
		echo "<li><a href=\"".$vars["path"]."land/Oostenrijk/\" rel=\"nofollow\">Wintersport in Oostenrijk</a></li>";
		echo "<li><a href=\"".$vars["path"]."land/Zwitserland/\" rel=\"nofollow\">Wintersport in Zwitserland</a></li>";
		echo "<li><a href=\"".$vars["path"]."land/Italie/\" rel=\"nofollow\">Wintersport in Itali&euml;</a></li>";
		// echo "<li><a href=\"".$vars["path"]."land/Duitsland/\" rel=\"nofollow\">Wintersport in Duitsland</a></li>";
		echo "</ul>";
		echo "</div>";
		echo "<div class=\"divContentIND\">";
		...
		echo "<ul>";
		echo "<li><a href=\"".$vars["path"]."plaats/Konigsleiten/\" rel=\"nofollow\">Wintersport in K&ouml;nigsleiten</a></li>";
	...
	if($id!="index") {
		...
		echo "<div class=\"divSepIND\">";
		echo "<br><b>&copy; ".wt_he($vars["websitenaam"])."</b><br><br>";
		echo "<ul><li><a href=\"".$vars["path"]."conditions.php\" rel=\"nofollow\">Conditions</a></li><li><a href=\"".$vars["path"]."disclaimer.php\" rel=\"nofollow\">Disclaimer</a></li><li><a href=\"".$vars["path"]."privacy-statement.php\" rel=\"nofollow\">Privacy statement</a></li><li><a href=\"".$vars["path"]."sitemap\" rel=\"nofollow\">Sitemap</a></li></ul>";
		echo "</div>";
		echo "</div>";
		echo "<div class=\"wrap\">";
		echo "<div class=\"divContentIND\">";
