...
if($_GET["pagetype"]=="landing-italissima") {
	...
	if($_GET["pagecontent"]=="agriturismo-italie") {
		...
		$landing_content2_html="<h2>Wat maakt een agriturismo in Itali&euml; zo bijzonder?</h2><p>Een vakantie op een agriturismo in Itali&euml; heeft het volgende te bieden:<ul>
        ...
        $landing_moretext_header_tag = "h5";
		$landing_content_slide_html="<h3>Onze agriturismi in Itali&euml;</h3>
        ...
        $landing_searchtext_header_tag = "h4";
	...
	if($landing_photo and $landing_title and $landing_content_html) {
		...
		$pre_query_content .= "<h1 style=\"margin-bottom:10px;color:#661700;\">".wt_he($landing_title)."</h1><img src=\"".$vars["path"]."pic/".$landing_photo."\" alt=\"Hoofdfoto ". $landing_title . "\" width=\"250\" style=\"float:left;margin-right:10px;".$landing_photo_style."\"><p>".$landing_content_html."</p><div style=\"clear: both;\"></div></div>";

		$pre_query_content .= $landing_content2_html;

		$pre_query_content .= "<div style=\"text-align:right;margin-bottom:15px;\"><" . $landing_moretext_header_tag . "><a href=\"#\" class=\"slide_more\" data-open=\"".wt_he($landing_moretext)." &raquo;\" data-close=\"&laquo; inklappen\">".wt_he($landing_moretext)." &raquo;</a></" . $landing_moretext_header_tag . "></div>";



		$pre_query_content .= "<div class=\"slide_more_div\">".$landing_content_slide_html."<br/></div>";

		$pre_query_content .= "<" . $landing_searchtext_header_tag . " style=\"color: #661700; font-size:1.2em; padding:0; margin: 0; font-weight:bold;\">".wt_he($landing_searchtext).":</" . $landing_searchtext_header_tag . "><br/>";
